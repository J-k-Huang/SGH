...
class Predictor(nn.Module):
    def __init__(self, prob=0.5):
        ...
        self.fc3 = nn.Linear(1024,31)
        self.bn_fc3 = nn.BatchNorm1d(31)
        self.prob = prob
...
class AE(nn.Module):
    def __init__(self, num_classes=31,num_layer = 2,ngf=32,norm_layer=nn.BatchNorm2d):
...
class Resbridge(nn.Module):
    def __init__(self, num_classes=31,num_layer = 2,num_unit=2048,prob=0.5):
